...
export class ListaReportesComponent implements  AfterViewInit {
  ...
  public reportes: Array<any>=[
    { id : 1 , nombre_reporte: 'OEE Amut 1' , link:'' , activo: true},
    ...
    { id : 7 , nombre_reporte: 'Fallas Amut 1' , link:'' , activo: true},
    { id : 8 , nombre_reporte: 'Fallas Amut 2' , link:'' , activo: true},
    { id : 9 , nombre_reporte: 'Fallas Extrusion 1' , link:'' , activo: true},
    { id : 10 , nombre_reporte: 'Fallas Extrusion 2 ' , link:'' , activo: true},
    { id : 11 , nombre_reporte: 'Fallas PTAR' , link:'' , activo: true},
    { id : 12 , nombre_reporte: 'Fallas SSP' , link:'' , activo: true},
    { id : 13 , nombre_reporte: 'ETAD Amut (A1 y A2)' , link:'' , activo: true},
    ...
    { id : 21 , nombre_reporte: 'OEE Anual Amut ' , link:'' , activo: true},
    { id : 22 , nombre_reporte: 'OEE Anual Buhler (E1 y E2)' , link:'' , activo: true},
    { id : 23 , nombre_reporte: 'OEE Anual PTAR' , link:'' , activo: true},
    { id : 24 , nombre_reporte: 'OEE Anual SSP' , link:'' , activo: true}
  ];
