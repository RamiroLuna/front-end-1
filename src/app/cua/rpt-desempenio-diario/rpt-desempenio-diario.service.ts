...
@Injectable()
export class RptDesempenioDiarioService {
  ...
  reporteDailyPerformance(id_usuario: number, params:any): Observable<any> {
    return this.http.get<any>(this.URL + '?action=reporteDailyPerformance&id_usuario=' + id_usuario + '&id_periodo='+params.idPeriodo +'&id_linea='+params.idLinea);
  }
