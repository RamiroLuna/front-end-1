...
export class ListCatalogsComponent implements  AfterViewInit  {
  ...
  public catalogos: Array<any>=[
    ...
    { id : 2 , name:'pet_cat_tipo_producto', descripcion: 'Tipo producto' , link: 'tipo_productos', activo: true},
    ...
    { id : 5 , name:'pet_cat_razon_paro', descripcion: 'Razon de paro' , link: 'razones', activo: true}
  ];
